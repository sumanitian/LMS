...
char catagories[][22]={"C language","Operating System","Computer Fundamental","DBMS","DOS","Architecture","Electronics","Physics","Mathematics","C++","Internet & Networking","Linux","Data Structures & Algorithm","DCO","OOPS","Java","Interet & Web Designing","Network Security","Visual Basics","SQL Server","SAD"};
...
void mainmenu()
{
	...
	case '4':
		...
		system("cls");
		gotoxy(16,3);
		printf("Copyright © 2020, Suman Prasad");
		gotoxy(16,4);
		printf("All Rights Reserved");
		gotoxy(16,5);
		printf("Developed & Maintained by Suman Prasad");
		gotoxy(16,7);
...
void addbooks(void)    //funtion that add books
{
	...
	gotoxy(20,7);
	printf("\xDB\xDB\xDB\xDB\xB2 1. C language");
	gotoxy(20,9);
	printf("\xDB\xDB\xDB\xDB\xB2 2. Operating System");
	gotoxy(20,11);
	printf("\xDB\xDB\xDB\xDB\xB2 3. Computer Fundamental");
	gotoxy(20,13);
	printf("\xDB\xDB\xDB\xDB\xB2 4. DBMS");
	gotoxy(20,15);
	printf("\xDB\xDB\xDB\xDB\xB2 5. DOS");
	gotoxy(20,17);
	printf("\xDB\xDB\xDB\xDB\xB2 6. Architecture");
	gotoxy(20,19);
	printf("\xDB\xDB\xDB\xDB\xB2 7. Electronics");
	gotoxy(20,21);
	printf("\xDB\xDB\xDB\xDB\xB2 8. Physics");
	gotoxy(20,23);
	printf("\xDB\xDB\xDB\xDB\xB2 9. Mathematics");
	gotoxy(20,25);
	printf("\xDB\xDB\xDB\xDB\xB2 10. C++");
	gotoxy(20,27);
	printf("\xDB\xDB\xDB\xDB\xB2 11. Internet & Networking");
	gotoxy(20,29);
	printf("\xDB\xDB\xDB\xDB\xB2 13. Linux");
	gotoxy(20,31);
	printf("\xDB\xDB\xDB\xDB\xB2 14. Data Structures & Algorithm");
	gotoxy(20,33);
	printf("\xDB\xDB\xDB\xDB\xB2 15. DCO");
	gotoxy(20,35);
	printf("\xDB\xDB\xDB\xDB\xB2 16. OOPS");
	gotoxy(20,37);
	printf("\xDB\xDB\xDB\xDB\xB2 17. Java");
	gotoxy(20,39);
	printf("\xDB\xDB\xDB\xDB\xB2 18. Interet & Web Designing");
	gotoxy(20,41);
	printf("\xDB\xDB\xDB\xDB\xB2 19. Network Security");
	gotoxy(20,43);
	printf("\xDB\xDB\xDB\xDB\xB2 20. Visual Basics");
	gotoxy(20,45);
	printf("\xDB\xDB\xDB\xDB\xB2 21. SQL Server");
	gotoxy(20,47);
	printf("\xDB\xDB\xDB\xDB\xB2 22. SAD");
	gotoxy(20,49);
	printf("\xDB\xDB\xDB\xDB\xB2 23. Back to main menu");
	gotoxy(20,51);
	printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
	gotoxy(20,50);
	printf("Enter your choice:");
